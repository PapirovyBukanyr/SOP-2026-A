...
Tento jev lze modelovat zavedením kvadratického členu do účelové funkce. Pokud by prodejní cena (a tím i zisk) klesala s množstvím vyrobených kusů $x$, celkový zisk za základní stoly by byl $(250 - x) \cdot x = 250x - x^2$. Účelová funkce by se pak změnila takto:
$$z = 250x - x^2 + 350y$$
